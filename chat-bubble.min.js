...
(function () {
  ...
  const icons = {
    messageCircle:
      '<span class="chat-bubble-icon" style="width:100%;height:100%;border-radius:50%;background:#ffffff;display:inline-flex;align-items:center;justify-content:center;overflow:hidden;"><img src="https://storage.googleapis.com/chat.azrienlabs.com/chat-bubble/bot-icon.png" alt="bot" style="display:block;width:100%;height:100%;object-fit:cover;"/></span>',
    ...
    bot: '<img src="https://storage.googleapis.com/chat.azrienlabs.com/chat-bubble/bot-icon.png" alt="bot" class="bot-icon" />',
...
.chat-input {
  ...
  padding: 12px 56px 12px 16px; /* reserve space on right for send button */
font-size: 14px;
resize: none;
min-height: 40px;
max-height: 96px;
...
display: block;
            ...
            /* Scoped hidden class to avoid colliding with site-wide utilities (eg. Tailwind) */
